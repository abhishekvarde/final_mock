...
def display_results(request):
    if request.user.is_authenticated and request.user.username == "super_admin":
        ...
        if request.method == 'POST':
            ...
            query = """ 
                           SELECT sts.first_name,sts.last_name,sts.college,sts.address_line_1,sts.city,sts.taluka,sts.district,sts.state,sts.email,sts.phone_no,sts.alt_phone_no,str.exam_type,str.physics_marks,str.chemistry_marks,str.math_marks,str.biology_marks,str.total_marks,au.date_joined
